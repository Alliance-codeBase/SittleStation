...
<<<<<<< HEAD:code/modules/food_and_drinks/food/snacks.dm
	foodtypes = JUNKFOOD | FRIED | GRAIN
	food_flags = FOOD_FINGER_FOOD
=======
	foodtypes = JUNKFOOD | FRIED
>>>>>>> parent of c1c522274a5 (Merge branch 'efficency' of https://github.com/Glamyrio/PostMeta into fixes):code/game/objects/items/food/snacks.dm
	w_class = WEIGHT_CLASS_SMALL
